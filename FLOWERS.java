...
public class FLOWERS extends PLANT {
    ...
    // This is the method that check where the grow start, so we don't need to
    // grow from 2,2 every time.
    ...
    // This is the method that do the grow step, it will check four directions
    // and grow if possible, also, it will record the point that growed, chech
    // it's growablity, if it can grow again, it will be return back for next
    // grow.
